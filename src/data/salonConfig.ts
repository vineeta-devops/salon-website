export const salonConfig = {
  ...
  services: [
    ...
    { id: 2, category: "Hair", name: "Hair Spa", description: "Deep nourishment and relaxation treatment for healthier, smoother hair.", price: "Starting from ₹999", image: "https://images.unsplash.com/photo-1519014816548-bf5fe059698b?auto=format&fit=crop&q=80&w=800" },
    ...
    { id: 9, category: "Bridal", name: "Bridal Makeup", description: "Comprehensive bridal beauty package for your perfect day.", price: "Starting from ₹7,999", image: "https://images.unsplash.com/photo-1595015949162-87f5492ff9e2?auto=format&fit=crop&q=80&w=800" },
    { id: 10, category: "Bridal", name: "Pre-Bridal Package", description: "Complete head-to-toe grooming sessions leading up to the wedding.", price: "Starting from ₹14,999", image: "https://images.unsplash.com/photo-1606820546684-263a23a85b9b?auto=format&fit=crop&q=80&w=800" },
  ...
  offers: [
    ...
    { id: 3, title: "Bridal Beauty Package", description: "Bridal Makeup + Hair Styling", price: "Starting from ₹8,999", originalPrice: "₹12,000", badge: "Premium", validText: "Booking required 1 week prior", image: "https://images.unsplash.com/photo-1595015949162-87f5492ff9e2?q=80&w=800" },
  ...
  gallery: [
    ...
    { id: 5, category: "Bridal", title: "Bridal Perfection", image: "https://images.unsplash.com/photo-1595015949162-87f5492ff9e2?auto=format&fit=crop&q=80&w=800", alt: "Stunning bride with elegant makeup and traditional attire" },
    ...
    { id: 8, category: "Hair", title: "Vibrant Hair Colour", image: "https://images.unsplash.com/photo-1519014816548-bf5fe059698b?auto=format&fit=crop&q=80&w=800", alt: "Beautifully colored and textured healthy hair" },
    ...
    { id: 12, category: "Bridal", title: "Pre-Bridal Preparation", image: "https://images.unsplash.com/photo-1606820546684-263a23a85b9b?auto=format&fit=crop&q=80&w=800", alt: "Bride getting ready with delicate makeup adjustments" },
